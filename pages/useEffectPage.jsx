...
export const UseEffectPage = () => {
	return (
		...
		<p className="font-bold md:text-lg">
			5. "Debounce" de Input para Buscas em Tempo Real (buscar a cada x segundos)
		</p>
		<div className="w-full flex justify-center">
			<BuscaDebounced/>
		</div>
		<p className="text-xs md:text-sm">
			Em um campo de busca, fazer uma chamada de API a cada tecla pressionada é extremamente ineficiente e sobrecarrega o servidor. O ideal é esperar o usuário parar de digitar por um instante antes de fazer a busca.
			<br></br><br></br>
			Usamos o useEffect com um setTimeout. A mágica está na função de limpeza, que cancela o timer anterior toda vez que o usuário digita algo novo.
		</p>
